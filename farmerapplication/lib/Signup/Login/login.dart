...
import 'package:farmerapplication/Signup/Login/firebase_services.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  // Function to check if the user wants to stay logged in
  ...
  // Function to handle sign-in with stored credentials
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: Gtext(
                      text: 'Enter Your Farmer Loging Details Here....',
                      tsize: 25,
                      tcolor: Colors.black,
